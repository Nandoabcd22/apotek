                    ...
                    <tbody>
                        @forelse ($obats as $obat)
                            <tr>
                                ...
                                <td>
                                    <a href="{{ route('obats.show', $obat) }}" class="btn btn-sm btn-info">
                                        <i class="bi bi-eye"></i>
                                    </a>
                                    <a href="{{ route('obats.edit', $obat) }}" class="btn btn-sm btn-warning">
                                        <i class="bi bi-pencil"></i>
                                    </a>
                                    <form action="{{ route('obats.destroy', $obat) }}" method="POST" style="display:inline;">
                                        @csrf
                                        @method('DELETE')
