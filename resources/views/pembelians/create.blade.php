...
@section('content')
    <div class="page-header">
        <h3 class="mb-0">Buat Pembelian Baru</h3>
    </div>

    <div class="row">
        <div class="col-md-12">
            <form action="{{ route('pembelians.store') }}" method="POST" id="formPembelian">
                @csrf
                        ...
                        <div class="card">
                            <div class="card-body">
                                <div class="mb-3">
                                    ...
                                    <input type="text" class="form-control @error('no_pembelian') is-invalid @enderror" 
                                           id="no_pembelian" name="no_pembelian" required>
                                    @error('no_pembelian')
                            ...
                            <div class="card-body">
                                <div class="mb-3">
                                    ...
                                    <input type="date" class="form-control @error('tanggal_pembelian') is-invalid @enderror" 
                                           id="tanggal_pembelian" name="tanggal_pembelian" value="{{ date('Y-m-d') }}" required>
                            ...
                            <div class="card-body">
                                <div class="mb-3">
                                    ...
                                    <input type="number" class="form-control @error('diskon') is-invalid @enderror" 
                                           id="diskon" name="diskon" value="0" min="0" max="100" step="0.01">
                                    @error('diskon')
                                        <div class="invalid-feedback">{{ $message }}</div>
                                    @enderror
                                </div>
                ...
                <tr class="item-row" data-item="${itemCount}">
                    <td>
                        <select class="form-select obat-select" name="items[${itemCount}][id_obat]" required onchange="updateItemPrice(${itemCount})">
                            ...
                            ${obats.map(o => `<option value="${o.id_obat}" data-harga="${o.harga_beli}">${o.nama_obat}</option>`).join('')}
                        </select>
                    </td>
                    <td>
